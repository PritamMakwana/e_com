...
@section('content')
    ...
    {{-- BANNER SECTION --}}
    <div class="rts-banner-area-two mt--40">
        <div class="container">
            <div class="row g-4">
...
--}}
                    ...
                    <div class="category-area-main-wrapper-one">
                        <div class="swiper mySwiper-category-1 swiper-data"
                            ...
                            "breakpoints":{
                                ...
                                "640":{"slidesPerView":4},
                                "840":{"slidesPerView":4},
                                "1140":{"slidesPerView":{{ $categorieCount }}}
                            }
                        }'>
                            <div class="swiper-wrapper">
                        ...
                        <div class="icon">
                            <svg width="37" height="44" viewBox="0 0 37 44" fill="none"
                                ...
                                <path
                                    ...
                                    fill="#629D23" />
                                <path d="M10.5466 34.0632L23.2407 18.599L25.1911 20.249L12.4969 35.7132L10.5466 34.0632Z"
                                    fill="#629D23" />
                            </svg>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            ...
                            <div class="single-blog-area-start">
                                <a href="#" class="thumbnail">
                                    <img src="{{ asset('storage/' . $blog->image) }}" alt="{{ $blog->title }}" style="height: 200px;">
                                </a>
    ...
    @if ($testimonials->count())
        <div class="blog-area-start rts-section-gapBottom bg_light-1">
            <div class="container">
                ...
                <div class="row g-4">
                    @foreach ($testimonials as $testimonial)
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            ...
                            <div class="single-blog-area-start text-center">

                                <div class="thumbnail">
                                    <img src="{{ $testimonial->image ? asset('storage/' . $testimonial->image) : asset('assets/images/user.png') }}"
                                        alt="{{ $testimonial->name }}"
                                        style="border-radius:50%; width:120px; height:120px; object-fit:cover;margin-bottom: 10px;margin-top: 10px">
                                </div>

                                <div class="blog-body">
                                    <h4 class="title">{{ $testimonial->name }}</h4>
                                    <span class="text-muted">{{ $testimonial->designation }}</span>
